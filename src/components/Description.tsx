    ...
    <section className="py-8 sm:py-12 bg-white w-full">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="bg-white rounded-3xl p-8 shadow-lg border border-[#5B5F3D]/10 max-w-4xl mx-auto">
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1 w-full">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-[#5B5F3D] mb-2">Lundi à Vendredi</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#5B5F3D] mb-2">Samedi</h4>
                      <ul className="space-y-2 text-gray-600">
                        <li className="flex items-center justify-between">
                          <span>Journée continue</span>
                    ...
                    <ul className="space-y-2 text-gray-600 text-sm pt-4">
          ...
          >
            <div className="inline-flex gap-4 flex-col sm:flex-row justify-center mb-6">
              <Link href="/prestations">
                <span className="inline-flex items-center gap-2 px-6 py-3 bg-[#5B5F3D] text-white rounded-full 
                  hover:bg-[#4A4E2F] transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
                  <span>Découvrir nos prestations</span>
          ...
          >
            ...
            <motion.div 
              variants={fadeInUp}
              className="w-full h-[400px] rounded-2xl overflow-hidden shadow-lg max-w-4xl mx-auto"
            >
              <iframe
            ...
            <motion.div 
              variants={fadeInUp}
              className="text-center mt-6 flex flex-col sm:flex-row items-center justify-center gap-4"
            >
              <a 
                href="https://www.google.com/maps/dir/?api=1&destination=48.5199858,2.6742563" 
                target="_blank"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#5B5F3D] text-white rounded-full font-medium 
