  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-16 md:pt-20">
        {/* Hero Section */}
        <section className="relative py-6 md:py-10 bg-gradient-to-b from-brand/10 via-brand/5 to-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mt-4 mb-2">
                Contact Dog'Factory
              </h1>
        ...
        <section className="py-6 md:py-10">
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              ...
              <motion.div 
                className="lg:hidden bg-white rounded-2xl shadow-xl p-6 border border-gray-100 mb-6"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
              >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  {/* Map */}
                  <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 h-[300px] lg:h-[350px]">
                    <iframe
        ...
        {/* Call to Action */}
        <section className="py-6 md:py-10 bg-gradient-to-t from-brand/5 to-white">
          <div className="container mx-auto px-4">
            <motion.div 
              className="max-w-4xl mx-auto text-center"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <motion.a
                href="tel:0658166105"
                className="inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-medium text-white bg-brand rounded-full hover:bg-brand/90 transition-colors shadow-lg hover:shadow-xl"
