...
const SocialLink = ({ href, icon: Icon, label }: { href: string; icon: any; label: string }) => (
  <motion.a
    ...
    className="flex flex-col md:flex-row items-center gap-1 md:gap-3 p-2 md:p-4 rounded-xl bg-gray-50 hover:bg-brand/10 text-gray-600 hover:text-brand transition-all text-xs md:text-base"
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white pt-16 md:pt-20">
        {/* Hero Section */}
        <section className="relative py-4 md:py-6 bg-gradient-to-b from-brand/10 via-brand/5 to-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            ...
            >
              ...
              <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-gray-900 mt-3 mb-2">
                Contact Dog'Factory
              </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                ...
                >
                  ...
                  <div className="bg-white rounded-2xl shadow-xl p-4 md:p-6 border border-gray-100">
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <motion.a
                        href="tel:0658166105"
                        className="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl bg-gray-50 hover:bg-brand/10 text-gray-600 hover:text-brand transition-all text-sm md:text-base"
                      ...
                      <div className="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl bg-gray-50 text-sm md:text-base">
                        <FaMapMarkerAlt className="w-4 h-4 md:w-5 md:h-5 text-brand shrink-0" />
                ...
                {/* Right Column: Contact Form - Visible uniquement sur desktop */}
                <motion.div 
              ...
              >
                <div className="bg-white rounded-2xl shadow-xl p-4 md:p-6 border border-gray-100">
                  ...
                  <p className="text-xs md:text-base text-gray-600 mb-3 md:mb-4 leading-relaxed text-center">
        ...
        {/* Call to Action */}
        <section className="py-4 md:py-6 bg-gradient-to-t from-brand/5 to-white">
          <div className="container mx-auto px-4">
            <motion.div 
              className="max-w-4xl mx-auto text-center"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <motion.a
                href="tel:0658166105"
                className="inline-flex items-center justify-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-brand text-white text-sm md:text-base font-medium rounded-full hover:bg-brand/90 transition-colors"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <FaPhone className="w-4 h-4" />
                <span>Appelez-nous au 06 58 16 61 05</span>
              </motion.a>
            </motion.div>
          </div>
        </section>
